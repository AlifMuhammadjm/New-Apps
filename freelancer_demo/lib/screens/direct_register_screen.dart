...
import 'direct_login_screen.dart';

class DirectRegisterScreen extends StatefulWidget {
  const DirectRegisterScreen({Key? key}) : super(key: key);

  @override
  State<DirectRegisterScreen> createState() => _DirectRegisterScreenState();
}
...
class _DirectRegisterScreenState extends State<DirectRegisterScreen> {
  ...
  Future<void> _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        // Registrasi dengan email password langsung menggunakan Supabase
